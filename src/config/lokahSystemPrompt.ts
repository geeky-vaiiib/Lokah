...
reply_text — the human-friendly message to user (first-person as alternate self).
...
Input (task=chat_turn): user asks “How’s life?”; alternate self = retired pro cricketer who coaches.
...
Example 2 — Generate alternate self (from divergence axes)
...
Context:
{
  "user": {"id":"u_123", "name":"Vaibhav"},
  "profile": {"country":"India","languages":["English","Kannada"], "economic_status":"comfortable", "trauma_flag":false},
  "parallel_self": {"id":"p_01", "divergence_axes":{"career":"cricket_coach","location":"Bengaluru"},"backstory":"...","core_traits":["patient","nostalgic","pragmatic"], "memory_snippets":["I love the smell of fresh-cut grass"]},
